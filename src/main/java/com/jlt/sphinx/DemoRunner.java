package voice.sphinx;

import voice.sphinx.aligner.AlignerDemo;
import voice.sphinx.dialog.DialogDemo;
import voice.sphinx.speakerid.SpeakerIdentificationDemo;
import voice.sphinx.transcriber.TranscriberDemo;
