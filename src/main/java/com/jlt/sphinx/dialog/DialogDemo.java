...
public class DialogDemo {
    ...
    private static final String GRAMMAR_PATH = "resource:/voice/sphinx/dialog/";
    private static final String LANGUAGE_MODEL = "resource:/voice/sphinx/dialog/weather.lm";
